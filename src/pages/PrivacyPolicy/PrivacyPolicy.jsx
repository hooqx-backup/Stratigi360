...
const PrivacyPolicy = () => {
  ...
  useEffect(() => {
    const sections = privacy.sections.map(s => document.getElementById(s.id)).filter(Boolean)
        ...
        <div className="container pp-content__grid">
          ...
          <div className="pp-body">
            ...
            >
              ...
              <p className="pp-intro-card__text">{privacy.intro}</p>
            </motion.div>
            ...
            >
              ...
              <p className="pp-consent__text">
                By using our website and services, you consent to the terms outlined in this Privacy Policy. If you do not agree with any part of this policy, please discontinue use of our services.
              </p>
            </motion.div>
          </div>
